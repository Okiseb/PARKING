...
namespace Parking\CoreBundle\Controller;
...
class CoreController extends Controller
{
  ...
  public function indexAction()
  {
    ...
    return $this->get('templating')->renderResponse('ParkingCoreBundle:Core:index.html.twig');
  ...
  public function contactAction(Request $request)
  {
    ...
    return new RedirectResponse($this->get('router')->generate('parking_core_home'));
